    ...
    <nav class="sidebar__nav">
        <ul class="sidebar__list">
            <li class="sidebar__item">
                <a href="dashboard.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'sidebar__link--active' : '' ?>">
            ...
            <li class="sidebar__item">
                <a href="portfolio.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'portfolio.php' ? 'sidebar__link--active' : '' ?>">
                    <svg class="sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <li class="sidebar__item">
                <a href="contacts.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'contacts.php' ? 'sidebar__link--active' : '' ?>">
                    <svg class="sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <li class="sidebar__item">
                <a href="templates.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'templates.php' ? 'sidebar__link--active' : '' ?>">
                    <svg class="sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <li class="sidebar__item">
                <a href="appearance.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'appearance.php' ? 'sidebar__link--active' : '' ?>">
                    <svg class="sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <li class="sidebar__item">
                <a href="settings.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'settings.php' ? 'sidebar__link--active' : '' ?>">
                    <svg class="sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <li class="sidebar__item">
                <a href="profile.php" class="sidebar__link <?= basename($_SERVER['PHP_SELF']) == 'profile.php' ? 'sidebar__link--active' : '' ?>">
                    <svg class="sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
